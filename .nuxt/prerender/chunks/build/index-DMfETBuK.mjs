...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="bell-icon" data-v-d81ffb1b> \u{1F514} <div class="bell-ripple" data-v-d81ffb1b></div></div></div></div><div class="hero-stats" data-v-d81ffb1b><div class="stat-item" data-v-d81ffb1b><span class="stat-number" data-v-d81ffb1b>500+</span><span class="stat-label" data-v-d81ffb1b>${ssrInterpolate(t.value.stats.clients)}</span></div><div class="stat-item" data-v-d81ffb1b><span class="stat-number" data-v-d81ffb1b>98%</span><span class="stat-label" data-v-d81ffb1b>${ssrInterpolate(t.value.stats.success)}</span></div><div class="stat-item" data-v-d81ffb1b><span class="stat-number" data-v-d81ffb1b>10+</span><span class="stat-label" data-v-d81ffb1b>${ssrInterpolate(t.value.stats.experience)}</span></div></div></div><div class="hero-decoration" data-v-d81ffb1b><div class="decoration-circle circle-1" data-v-d81ffb1b></div><div class="decoration-circle circle-2" data-v-d81ffb1b></div><div class="decoration-circle circle-3" data-v-d81ffb1b></div></div></div><div class="services" data-v-d81ffb1b><div class="service-card" data-v-d81ffb1b><div class="service-icon" data-v-d81ffb1b>\u{1F331}</div><h2 data-v-d81ffb1b>${ssrInterpolate(t.value.services.growth.title)}</h2><p data-v-d81ffb1b>${ssrInterpolate(t.value.services.growth.description)}</p></div><div class="service-card" data-v-d81ffb1b><div class="service-icon" data-v-d81ffb1b>\u{1F4BC}</div><h2 data-v-d81ffb1b>${ssrInterpolate(t.value.services.career.title)}</h2><p data-v-d81ffb1b>${ssrInterpolate(t.value.services.career.description)}</p></div><div class="service-card" data-v-d81ffb1b><div class="service-icon" data-v-d81ffb1b>\u2764\uFE0F</div><h2 data-v-d81ffb1b>${ssrInterpolate(t.value.services.relationships.title)}</h2><p data-v-d81ffb1b>${ssrInterpolate(t.value.services.relationships.description)}</p></div></div><div class="cta-section" data-v-d81ffb1b><p class="intro" data-v-d81ffb1b>${ssrInterpolate(t.value.cta.intro)}</p><button class="cta-button" data-v-d81ffb1b>${ssrInterpolate(t.value.cta.button)}</button></div><div class="customer-service" data-v-d81ffb1b><div class="cs-card" data-v-d81ffb1b><div class="cs-icon" data-v-d81ffb1b>\u{1F4AC}</div><h3 data-v-d81ffb1b>${ssrInterpolate(t.value.support.chat.title)}</h3><p data-v-d81ffb1b>${ssrInterpolate(t.value.support.chat.description)}</p><button class="cs-button" data-v-d81ffb1b>${ssrInterpolate(t.value.support.chat.button)}</button></div><div class="cs-card" data-v-d81ffb1b><div class="cs-icon" data-v-d81ffb1b>\u{1F4DE}</div><h3 data-v-d81ffb1b>${ssrInterpolate(t.value.support.phone.title)}</h3><p data-v-d81ffb1b>${ssrInterpolate(t.value.support.phone.description)}</p><button class="cs-button" data-v-d81ffb1b>${ssrInterpolate(t.value.support.phone.button)}</button></div><div class="cs-card" data-v-d81ffb1b><div class="cs-icon" data-v-d81ffb1b>\u2709\uFE0F</div><h3 data-v-d81ffb1b>${ssrInterpolate(t.value.support.email.title)}</h3><p data-v-d81ffb1b>${ssrInterpolate(t.value.support.email.description)}</p><button class="cs-button" data-v-d81ffb1b>${ssrInterpolate(t.value.support.email.button)}</button></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=index-DMfETBuK.mjs.map
