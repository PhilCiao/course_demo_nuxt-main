...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="bell-icon" data-v-fb502230> \u{1F514} <div class="bell-ripple" data-v-fb502230></div></div></div></div><div class="hero-stats" data-v-fb502230><div class="stat-item" data-v-fb502230><span class="stat-number" data-v-fb502230>500+</span><span class="stat-label" data-v-fb502230>${ssrInterpolate(t.value.stats.clients)}</span></div><div class="stat-item" data-v-fb502230><span class="stat-number" data-v-fb502230>98%</span><span class="stat-label" data-v-fb502230>${ssrInterpolate(t.value.stats.success)}</span></div><div class="stat-item" data-v-fb502230><span class="stat-number" data-v-fb502230>10+</span><span class="stat-label" data-v-fb502230>${ssrInterpolate(t.value.stats.experience)}</span></div></div><div class="love-test-btn-wrapper" data-v-fb502230><a href="https://5Love.healingman.vip" target="_blank" class="love-test-btn" data-v-fb502230><span class="heart" data-v-fb502230>\u2764</span> \u7231\u7684\u8BED\u8A00\u5C0F\u6D4B\u8BD5 </a></div></div><div class="hero-decoration" data-v-fb502230><div class="decoration-circle circle-1" data-v-fb502230></div><div class="decoration-circle circle-2" data-v-fb502230></div><div class="decoration-circle circle-3" data-v-fb502230></div></div></div><div class="services" data-v-fb502230><div class="service-card" data-v-fb502230><div class="service-icon" data-v-fb502230>\u{1F331}</div><h2 data-v-fb502230>${ssrInterpolate(t.value.services.growth.title)}</h2><p data-v-fb502230>${ssrInterpolate(t.value.services.growth.description)}</p></div><div class="service-card" data-v-fb502230><div class="service-icon" data-v-fb502230>\u{1F4BC}</div><h2 data-v-fb502230>${ssrInterpolate(t.value.services.career.title)}</h2><p data-v-fb502230>${ssrInterpolate(t.value.services.career.description)}</p></div><div class="service-card" data-v-fb502230><div class="service-icon" data-v-fb502230>\u2764\uFE0F</div><h2 data-v-fb502230>${ssrInterpolate(t.value.services.relationships.title)}</h2><p data-v-fb502230>${ssrInterpolate(t.value.services.relationships.description)}</p></div></div><div class="cta-section" data-v-fb502230><p class="intro" data-v-fb502230>${ssrInterpolate(t.value.cta.intro)}</p><button class="cta-button" data-v-fb502230>${ssrInterpolate(t.value.cta.button)}</button></div><div class="customer-service" data-v-fb502230><div class="cs-card" data-v-fb502230><div class="cs-icon" data-v-fb502230>\u{1F4AC}</div><h3 data-v-fb502230>${ssrInterpolate(t.value.support.chat.title)}</h3><p data-v-fb502230>${ssrInterpolate(t.value.support.chat.description)}</p><button class="cs-button" data-v-fb502230>${ssrInterpolate(t.value.support.chat.button)}</button></div><div class="cs-card" data-v-fb502230><div class="cs-icon" data-v-fb502230>\u{1F4DE}</div><h3 data-v-fb502230>${ssrInterpolate(t.value.support.phone.title)}</h3><p data-v-fb502230>${ssrInterpolate(t.value.support.phone.description)}</p><button class="cs-button" data-v-fb502230>${ssrInterpolate(t.value.support.phone.button)}</button></div><div class="cs-card" data-v-fb502230><div class="cs-icon" data-v-fb502230>\u2709\uFE0F</div><h3 data-v-fb502230>${ssrInterpolate(t.value.support.email.title)}</h3><p data-v-fb502230>${ssrInterpolate(t.value.support.email.description)}</p><button class="cs-button" data-v-fb502230>${ssrInterpolate(t.value.support.email.button)}</button></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=index-DyXF6qE4.mjs.map
