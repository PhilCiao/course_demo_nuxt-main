...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="bell-icon" data-v-021bd722> 🔔 <div class="bell-ripple" data-v-021bd722></div></div></div></div><div class="hero-stats" data-v-021bd722><div class="stat-item" data-v-021bd722><span class="stat-number" data-v-021bd722>500+</span><span class="stat-label" data-v-021bd722>${ssrInterpolate(t.value.stats.clients)}</span></div><div class="stat-item" data-v-021bd722><span class="stat-number" data-v-021bd722>98%</span><span class="stat-label" data-v-021bd722>${ssrInterpolate(t.value.stats.success)}</span></div><div class="stat-item" data-v-021bd722><span class="stat-number" data-v-021bd722>10+</span><span class="stat-label" data-v-021bd722>${ssrInterpolate(t.value.stats.experience)}</span></div></div><div class="love-test-btn-wrapper" data-v-021bd722><a href="https://5Love.healingman.vip" target="_blank" class="love-test-btn" data-v-021bd722><span class="heart" data-v-021bd722>❤</span> 爱的语言小测试 </a></div></div><div class="hero-decoration" data-v-021bd722><div class="decoration-circle circle-1" data-v-021bd722></div><div class="decoration-circle circle-2" data-v-021bd722></div><div class="decoration-circle circle-3" data-v-021bd722></div></div></div><div class="services" data-v-021bd722><div class="service-card" data-v-021bd722><div class="service-icon" data-v-021bd722>🌱</div><h2 data-v-021bd722>${ssrInterpolate(t.value.services.growth.title)}</h2><p data-v-021bd722>${ssrInterpolate(t.value.services.growth.description)}</p></div><div class="service-card" data-v-021bd722><div class="service-icon" data-v-021bd722>💼</div><h2 data-v-021bd722>${ssrInterpolate(t.value.services.career.title)}</h2><p data-v-021bd722>${ssrInterpolate(t.value.services.career.description)}</p></div><div class="service-card" data-v-021bd722><div class="service-icon" data-v-021bd722>❤️</div><h2 data-v-021bd722>${ssrInterpolate(t.value.services.relationships.title)}</h2><p data-v-021bd722>${ssrInterpolate(t.value.services.relationships.description)}</p></div></div><div class="cta-section" data-v-021bd722><p class="intro" data-v-021bd722>${ssrInterpolate(t.value.cta.intro)}</p><button class="cta-button" data-v-021bd722>${ssrInterpolate(t.value.cta.button)}</button></div><div class="customer-service" data-v-021bd722><div class="cs-card" data-v-021bd722><div class="cs-icon" data-v-021bd722>💬</div><h3 data-v-021bd722>${ssrInterpolate(t.value.support.chat.title)}</h3><p data-v-021bd722>${ssrInterpolate(t.value.support.chat.description)}</p><button class="cs-button" data-v-021bd722>${ssrInterpolate(t.value.support.chat.button)}</button></div><div class="cs-card" data-v-021bd722><div class="cs-icon" data-v-021bd722>📞</div><h3 data-v-021bd722>${ssrInterpolate(t.value.support.phone.title)}</h3><p data-v-021bd722>${ssrInterpolate(t.value.support.phone.description)}</p><button class="cs-button" data-v-021bd722>${ssrInterpolate(t.value.support.phone.button)}</button></div><div class="cs-card" data-v-021bd722><div class="cs-icon" data-v-021bd722>✉️</div><h3 data-v-021bd722>${ssrInterpolate(t.value.support.email.title)}</h3><p data-v-021bd722>${ssrInterpolate(t.value.support.email.description)}</p><button class="cs-button" data-v-021bd722>${ssrInterpolate(t.value.support.email.button)}</button></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=index-HcFb_A12.js.map
